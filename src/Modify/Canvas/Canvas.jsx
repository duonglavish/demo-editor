...
import useChooseSizeModal from '../../hooks/useChooseSizeModal';
import ChooseSizeModal from '../../screens/chooseSizeModal/ChooseSizeModal'
import './Canvas.css';
...
const Canvas = ({ svgContent, locale, svgUpdate, onClose, log }) => {
  ...
  const {isShowing, toggle} = useChooseSizeModal();
...
Canvas.defaultProps = { svgContent: '<svg width="1480" height="480" xmlns="http://www.w3.org/2000/svg"></svg>' }
